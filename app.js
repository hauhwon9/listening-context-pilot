const songs = [
  {
    ...
    artist: "Yiruma",
    role: "Calm instrumental anchor",
    previewUrls: [
      "https://audio-ssl.itunes.apple.com/itunes-assets/AudioPreview125/v4/cb/24/ac/cb24ac75-128c-f817-7d81-7fbffbdaafe3/mzaf_10771880904938057317.plus.aac.p.m4a",
      "https://audio-ssl.itunes.apple.com/itunes-assets/AudioPreview211/v4/5d/e8/db/5de8db2a-16e9-9952-1e92-72c8bd66c466/mzaf_12453809584145821574.plus.aac.p.m4a"
    ]
  },
  {
    id: "S2",
    title: "Sweden",
    artist: "C418",
    role: "Calm ambient anchor",
    previewUrls: [
      "https://audio-ssl.itunes.apple.com/itunes-assets/AudioPreview221/v4/af/31/01/af310107-0572-ec8a-0e8b-d99035407230/mzaf_13152283240780583171.plus.aac.p.m4a"
    ]
  },
  {
    id: "S3",
    ...
    artist: "Lord Huron",
    role: "Low-energy emotional vocal bridge",
    previewUrls: [
      "https://audio-ssl.itunes.apple.com/itunes-assets/AudioPreview221/v4/4b/36/b7/4b36b739-1de7-e0ae-45da-9a66463127ac/mzaf_1821541347983595183.plus.aac.p.m4a",
      "https://audio-ssl.itunes.apple.com/itunes-assets/AudioPreview221/v4/49/4d/2c/494d2c61-919e-242d-955c-c7293963768d/mzaf_2058155132908207955.plus.aac.p.m4a"
    ]
  },
  {
    id: "S4",
    title: "普通朋友",
    artist: "陶喆",
    role: "Chinese R&B / vocal bridge",
    previewUrls: [
      "https://audio-ssl.itunes.apple.com/itunes-assets/AudioPreview125/v4/07/24/34/07243445-d94a-0f14-12a4-dd46a0886c15/mzaf_13292192010675386253.plus.aac.p.m4a",
      "https://audio-ssl.itunes.apple.com/itunes-assets/AudioPreview115/v4/75/ea/8f/75ea8fc6-c0ea-8d08-f63a-282669f5c641/mzaf_10097100719564941460.plus.aac.p.m4a"
    ]
  },
  {
    id: "S5",
    ...
    previewUrls: [
      ...
      "https://audio-ssl.itunes.apple.com/itunes-assets/AudioPreview115/v4/ea/c2/80/eac280ad-489d-f26f-73f6-f59e7a87258b/mzaf_2355654534574985933.plus.aac.p.m4a"
    ]
  },
  {
    id: "S6",
    title: "Blueming",
    artist: "IU",
    role: "Bright pop / K-pop bridge",
    previewUrls: [
      "https://audio-ssl.itunes.apple.com/itunes-assets/AudioPreview115/v4/99/56/19/995619c5-5310-d3b0-de45-0ff352bc58d9/mzaf_11001517585085545132.plus.aac.p.m4a"
    ]
  },
  {
    id: "S7",
    ...
    role: "Electronic pop bridge",
    previewUrls: [
      "https://audio-ssl.itunes.apple.com/itunes-assets/AudioPreview221/v4/e9/9d/6f/e99d6fdf-6b71-7567-a423-fce5e51ddad3/mzaf_17383656644300592526.plus.aac.p.m4a",
  ...
  },
  {
    ...
    artist: "The Weeknd",
    role: "Synth-pop / energetic bridge",
    previewUrls: [
  ...
  },
  {
    ...
    role: "Party energetic anchor",
    previewUrls: [
      "https://audio-ssl.itunes.apple.com/itunes-assets/AudioPreview115/v4/f7/f9/47/f7f947ce-098f-ccf5-16aa-00ef1db59719/mzaf_9115727429891431447.plus.aac.p.m4a",
      "https://audio-ssl.itunes.apple.com/itunes-assets/AudioPreview221/v4/bc/d6/e0/bcd6e0a8-35d7-d57c-30ec-94b598e90607/mzaf_10629840826511540946.plus.aac.p.m4a",
      "https://audio-ssl.itunes.apple.com/itunes-assets/AudioPreview211/v4/0d/b1/5c/0db15ca4-18ac-08ad-0c4d-94658dd4f9da/mzaf_4614271537063576617.plus.aac.p.m4a"
    ]
  },
  {
    id: "S10",
    title: "Dynamite",
    artist: "BTS",
    role: "K-pop high-energy social anchor",
    previewUrls: [
      "https://audio-ssl.itunes.apple.com/itunes-assets/AudioPreview221/v4/a3/a0/a6/a3a0a6b5-4715-b872-1aff-21e42634d9cd/mzaf_7224423421767640589.plus.aac.p.m4a",
...
function updatePreviewMessage(audio, text) {
...
function setAudioSource(audio, song, index = 0) {
  const urls = song.previewUrls || [];
  audio.dataset.sourceIndex = String(index);
  if (!urls[index]) {
    audio.hidden = true;
    audio.removeAttribute("src");
    updatePreviewMessage(audio, "Preview not available. Please use the original/search link below.");
    return;
  }

  audio.hidden = false;
  audio.src = urls[index];
  updatePreviewMessage(audio, index === 0 ? "30-second preview loaded." : `30-second preview loaded. Backup source ${index + 1}.`);
}

function loadAudioPreviews() {
  songs.forEach(song => {
    document.querySelectorAll(`audio[data-song-id="${song.id}"]`).forEach(audio => {
      setAudioSource(audio, song);
    });
  });
}
...
function attachAudioFallbacks() {
  document.querySelectorAll("audio").forEach(audio => {
    audio.addEventListener("error", () => {
      const song = songById[audio.dataset.songId];
      const nextIndex = Number(audio.dataset.sourceIndex || "0") + 1;
      setAudioSource(audio, song, nextIndex);
    });
  });
}
